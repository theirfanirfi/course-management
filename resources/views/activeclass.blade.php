...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content">
		  <div class="row">
		    <div class="col-sm-6">
		      <h1>designS2dio<small> Active Course</small></h1>
		    </div><!--.col-->
		    <div class="col-sm-4">
			...
			<div class="col-md-10">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<button class="btn btn-danger" style="float:right;" url2="{{URL::to('/home')}}" url="{{URL::to('/home/cancelEnrolment')}}/{{$user_id}}/{{$course->c_id}}" onclick="cancelEnrolmentExit(this);">Exit</button>
						</div>

					</div>
				</div>
				<img src="{{URL::to('/')}}/{{$course->image_path}}" style="width:100%;height:500px;" />
			</div>
  @endif
