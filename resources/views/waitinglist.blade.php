...
<head>
	...
	<title>designS2dio - waitinglist</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content">
		  <div class="row">
		    <div class="col-sm-6">
		      <h1>Waiting List <small></small></h1>
		    </div><!--.col-->
		    <div class="col-sm-4">
  							...
  							<table class="table table-bordered table-striped table-condensed cf">
  								<thead class="cf">
  									<tr>
  										...
  										<th class="numeric">Total Waiting Students</th>
  										<th class="numeric">Your Position</th>
  										<th>Cancel</th>
  								  </tr>
  								</thead>
  								<tbody>
  									...
  									<tr id="{{$course_id}}" >
  										<td>{{$course_name}}</td>
  										<td class="numeric">{{$waitingCount}}</td>
  										<td class="numeric">{{$position}}</td>
                      <td><button url="{{URL::to('/home/cancelEnrolment')}}/{{$user_id}}/{{$course_id}}" course_id="{{$course_id}}" onclick="cancelEnrolment(this);" class="btn btn-danger">Cancel</button></td>
  									</tr>
									@else
										<tr >
											<td colspan="4" style="text-align:center;">You are not in any waiting list.</td>
										</tr>
									@endif
  									</tbody>
  							</table>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div style="padding:12px;border-radius:8px; margin-right:70px;width:100px;background-color:white;color:black;transform: translate(0px,-100px);float:right;">Vacant<br/> 22</div>
        </div>
